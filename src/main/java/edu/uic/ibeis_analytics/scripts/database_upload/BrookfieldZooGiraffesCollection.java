...
public class BrookfieldZooGiraffesCollection {
    ...
    public enum BrookfieldZooGiraffesDbNames {
        ARNIETA("Arnieta"), FRANNY("Franny"), JASIRI("Jasiri"), MITHRA("Mithra"), POTOKA("Potoka"), NAG("NAG");
    ...
    public BrookfieldZooGiraffesCollection() {
        ...
        try {
            ...
            //Not a giraffe
            try {
                nag = ibeis.addIndividual(BrookfieldZooGiraffesDbNames.NAG.getValue());
            } catch (IndividualNameAlreadyExistsException e) {
                nag = findIndividual(BrookfieldZooGiraffesDbNames.NAG.getValue());
            }
    ...
    public List<IbeisIndividual> getIndividuals() {
        return Arrays.asList(arnieta,franny,jasiri,mithra,potoka,nag);
    }
}
